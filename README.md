...
My interest stems from my passion which relates to live streaming, something that I enjoy in my free time - where problems related to latency, sync, networking, video-encoding, learned rate-distortion optimization, robustly distributing content all occur.
